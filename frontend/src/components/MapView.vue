    ...
    <div>
      <v-navigation-drawer
        ...
        <v-list dense v-if="!mini">
          ...
          <v-list-item >
            <v-list-item-content>
              <v-list-item-title><v-btn width="100%" @click="showGridCoordinates = !showGridCoordinates">
          ...
          <v-list-item >
            <v-list-item-content>
              <v-list-item-title><v-btn width="100%" @click="hideMarkers = !hideMarkers">
          ...
          <v-list-item >
            <v-list-item-content>
              <v-list-item-title><v-btn width="100%" @click="zoomOut">
                Zoom Out
              </v-btn></v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item >
            <v-list-item-content>
              <v-list-item-title>
                ...
                <v-autocomplete return-object outlined dense :items="maps" v-model="selectedMap" placeholder="Select Map"></v-autocomplete>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item >
            <v-list-item-content>
              <v-list-item-title>
                ...
                <v-autocomplete return-object outlined dense :items="maps" v-model="overlayMap" placeholder="Select Map"></v-autocomplete>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item >
            <v-list-item-content>
              <v-list-item-title>
                ...
                <v-autocomplete return-object outlined dense :items="players" v-model="selectedPlayer" placeholder="Select Player">
                </v-autocomplete>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
